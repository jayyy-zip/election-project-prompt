      ...
      {!isHome && (
        <Link
          ...
          style={{
            ...
            width: "44px", height: "44px", borderRadius: "10px",  // 44px min touch target
            background: "var(--surface)", border: "1px solid var(--border)",
            color: "var(--text)", flexShrink: 0, textDecoration: "none",
          }}
        >
      ...
      <div style={{ flex: 1 }}>
        {isHome ? (
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            <div>
              <p style={{ fontSize: "16px", fontWeight: 700, color: "var(--text)", margin: 0, lineHeight: 1.2 }}>
                VoteSmart
              </p>
